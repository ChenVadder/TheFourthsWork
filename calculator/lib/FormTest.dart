...
class FormSample extends State<FormTest> {
  ...
  void _getMonthData(BuildContext context) {
    ...
    for (int i = 0; i < 12; i++) {
      ...
      dangyuenashui =
          _zongnashuishouru * _shuilv - _susuankouchu - shangyueleijinashui;
      ...
      data[i] = new MonthData(i + 1, dangyueshuihoushouru, sb, gjj,
          dangyuenashui, _zongnashuishouru, _shuilv);
    }
